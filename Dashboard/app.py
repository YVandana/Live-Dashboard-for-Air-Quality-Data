''' To Run go to the Dashboard Directory and run "python .\app.py" For location that uses all 4 parameters use Bexley - Slade Green Fidas 157 '''
import dash
...
if __name__ == "__main__":
    # previously app.run_server(debug=True)
    app.run(debug=True)